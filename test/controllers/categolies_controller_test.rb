...
class CategoliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoly" do
    assert_difference('Categoly.count') do
      post categolies_url, params: { categoly: { description: @categoly.description, name: @categoly.name } }
    end
  ...
  test "should update categoly" do
    patch categoly_url(@categoly), params: { categoly: { description: @categoly.description, name: @categoly.name } }
